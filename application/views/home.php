			...
			<div class="gtco-container">
				...
				<div class="row">
					<div class="col-md-4">
						...
						<a href="<?php echo base_url('assets/images/img_2.jpg'); ?>" class="gtco-card-item image-popup" title="Project name here.">
							<figure>
					...
					<div class="col-md-4">
						<a href="<?php echo base_url('assets/images/img_1.jpg'); ?>" class="gtco-card-item image-popup" title="Project name here.">
							<figure>
								<div class="overlay"><i class="ti-plus"></i></div>
					...
					<div class="col-md-4">
						<a href="<?php echo base_url('assets/images/img_4.jpg'); ?>" class="gtco-card-item image-popup" title="Project name here.">
							<figure>
								<div class="overlay"><i class="ti-plus"></i></div>
					...
					<div class="col-md-4">
						<a href="<?php echo base_url('assets/images/img_5.jpg'); ?>" class="gtco-card-item image-popup" title="Project name here.">
							<figure>
								<div class="overlay"><i class="ti-plus"></i></div>
					...
					<div class="col-md-4">
						<a href="<?php echo base_url('assets/images/img_6.jpg'); ?>" class="gtco-card-item image-popup" title="Project name here.">
							<figure>
								<div class="overlay"><i class="ti-plus"></i></div>
					...
					<div class="col-md-4">
						<a href="<?php echo base_url('assets/images/img_3.jpg'); ?>" class="gtco-card-item image-popup" title="Project name here.">
							<figure>
								<div class="overlay"><i class="ti-plus"></i></div>
								<img src="<?php echo base_url('assets/images/img_3.jpg'); ?>" alt="Image" class="img-responsive">
							</figure>
